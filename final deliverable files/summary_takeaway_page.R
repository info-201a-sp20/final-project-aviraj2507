...
#use tags$p in ui file to write it in the form of a paragraph
takeaways$second_visualisation <- "From the bar chart, we observe an upward trend as SAT score and median income 
...
#use tags$p in ui file to write it in the form of a paragraph
takeaways$third_visualisation <- "From this scatterplot, we observe a linear relationship between SAT scores and income.
